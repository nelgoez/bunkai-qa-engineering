...
- Name: integration/defects/defect-sync.test.ts >> BK-43: TMS-Defect Sync >> BK-240: Re-sync idempotency — no duplicate external items
- Location: tests/integration/defects/defect-sync.test.ts:26:3
